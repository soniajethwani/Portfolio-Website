...
export default function About() {
  ...
  return (
    ...
    >
      ...
      <p className='mb-3'>
        Currently over 90% through my Computer Science major and Java OCA Certified (Java SE 8 Oracle Certified Associate), I am ready to make strides in the tech industry. My skills are backed by the countless projects, research, and hackathons I've done over the past couple of years. I'm confident that with my experience in the professional world and the things I've learned in both my classes and my personal developments, I am a capable candidate for any company seeking a full-stack or backend software intern.
      </p>
